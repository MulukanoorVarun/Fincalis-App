...
class PanDetails extends StatefulWidget {
  ...
  final String from;
  const PanDetails(
      {super.key, required this.isworkdetailsCompleted, required this.from});
  @override
...
class _PanDetailsState extends State<PanDetails> {
  ...
  var upload_pan_image1 = false;
  var upload_aadhar_image = false;
  var upload_aadhar_image1 = false;
      ...
      if (data != null) {
        setState(() {
          if (data.settings?.success == 1) {
            ...
            _aadhaarController.text = data.data?.result?.aadhar ?? "";
             pan_image = data.data?.result?.panImage ?? "";
             aadhar_image = data.data?.result?.aadharImage ?? "";
          } else {
            is_loading = false;
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    SubmittDataModel? data =
    await UserApi.UploadPanImageApi(File(selected!.path), Userid!);
    setState(() {
      if (data != null && data.success == 1) {
        upload_pan_image = false;
        upload_pan_image1 = true;
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
  ...
  Future<void> _pickImage1(ImageSource source) async {
    ...
    SubmittDataModel? data =
    await UserApi.UploadAadharImageApi(File(selected!.path), Userid!);
    setState(() {
      if (data != null && data.success == 1) {
        upload_aadhar_image = false;
        upload_aadhar_image1 = true;
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  hintText: (widget.from == "Student")
                                      ? "Enter gaurdian PAN Number"
                                ...
                                onTap: () {
                                  if (pan_status == false) {
                                    if (panverifying) {
                                      ...
                                      if (_panController.text.length <
                                          10) {
                                        setState(() {
                                          panverifying = false;
                                          _validatePAN = "Please enter a valid PAN number";
                                        });
                                      } else {
                                        VerifyPanNumber();
                                      }
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: CustomPaint(
                              ...
                              child: Center(
                                child: _imageFile != null && !upload_pan_image
                                    ? Image.file(
                      ...
                      TextFormField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            if (cleanedValue.length == 12) {
                              final isValidAadhaar =
                              Verhoeff.isValid(cleanedValue);
                              if (!isValidAadhaar) {
                                _validateaadhar =
                                "Please check the Aadhar number you have given!";
                              } else {
                                _validateaadhar = "";
                              }
                            } else {
                        ...
                        decoration: InputDecoration(
                          hintText: (widget.from == "Student")
                              ? "Enter gaurdian 12 digit Aadhaar number"
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: CustomPaint(
                              ...
                              child:
                              Center(
                                child: _imageFile1 != null && !upload_aadhar_image
                                    ? Image.file(
                ...
                if (data != null)
                  {
                    setState(() {
                      if (data.settings?.success == 1) {
                        ...
                        aadharOTPverifying = false;
                        validateOtp =
                        "Please Enter a valid OTP recieved on your linked mobile number";
                        ScaffoldMessenger.of(context)
                            .showSnackBar(SnackBar(
                          content: Text(
                            "${data.settings?.message}!",
