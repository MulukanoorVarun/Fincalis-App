      ...
      if (data != null && data.data != null) {
        setState(() {
         if(data.data?.result?.isLoanAppComplete==true){
           Navigator.push(context, MaterialPageRoute(builder: (context) => MyNach()));
         }else{
           Navigator.push(context, MaterialPageRoute(builder: (context) => EMITenuresScreen(loanamount:loan_approved.toDouble())));
         }
        });
      } else {
      }
