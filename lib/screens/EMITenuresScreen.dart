...
class _EMITenuresScreenState extends State<EMITenuresScreen> {
  ...
  Future<void> LoanApplication() async {
    ...
    if (Userid != null) {
      await UserApi.LoanApplicationApi(_loanAmount.toInt(),monthlyEmi.toInt(),Userid,EmiDates!).then((data) {
        if (data != null) {
          setState(() {
            if (data.success == 1) {
        ...
        if (data != null) {
          setState(() {
            if (data.settings?.success == 1) {
              ...
              EmiDates=data.data?.result?.emiDates;
              print(EmiDates);
