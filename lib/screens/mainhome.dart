...
import 'package:fincalis/screens/firebasecrashlytics.dart';
...
class _MyMainHomeState extends State<MyMainHome> {
  ...
  void get_lat_log() async {
    ...
    setState(() {
      ...
      address= "${placemarks[0].subLocality.toString() + "," + placemarks[0].street!.toString() + "," + placemarks[0].locality!.toString()}";
    });
    SendigUserLatlongs();
  }
  ...
  Future<void> SendigUserLatlongs() async {
    var Userid = await PreferenceService().getString('user_id');
    await UserApi.SendigUserLatlongsApi(Userid!,lattitude.toString(),longitude.toString(),address)
        .then((data) => {
      if (data != null)
        {
          setState(() {
...
// Convert the String to an int
      ...
      if (data != null)
        {
          setState(() async {
            if (data.settings?.success == 1) {
              ...
              }else if(data.data?.result?.loanStatus=="disbursed pending"){
                is_selected=false;
                var res= await Navigator.push(
                    context,
                    MaterialPageRoute(
      ...
      if (data != null)
        {
          setState(() async {
            if (data.settings?.success == 1) {
              is_selected=false;
              if(data.data?.result?.status=="Authentication is pending"){
                var res= await Navigator.push(
                    context,
                    MaterialPageRoute(
  ...
  Widget build(BuildContext context) {
    ...
    String nameInitial = (name.trim().isNotEmpty)
    ...
    return
      ...
      child:(isDeviceConnected=="ConnectivityResult.wifi" || isDeviceConnected=="ConnectivityResult.mobile" ) ?
      Scaffold(
      appBar: AppBar(
        title: Row(
          children: [
      ...
      drawer: Drawer(
        ...
        child: ListView(
          ...
          children: <Widget>[
                ...
                Row(
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: profile_image != null ? NetworkImage(profile_image!) : null,
                      child: profile_image == ""
                          ? Text(
                        nameInitial,
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => Repaymenthistory()));
              },
            ),
            ListTile(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => MyHelpSupport()));
              },
            ),
            // ListTile(
            //   leading:Image(image:AssetImage("assets/gift.png"),
            //       width: 24
            //   ),
            ...
            ListTile(
              leading:Image(image:AssetImage("assets/termsandconditions.png"),
                  width: 24
              ),
            ...
            ListTile(
              leading:Image(image:AssetImage("assets/aboutusicon.png"),
                  width: 24
              ),
              title: Text('About Us',
                style: TextStyle(
                ...
                items: imgList.map((item) {
                  return InkWell(
                    onTap: () async {
                      ...
                      //   context,
                      //   MaterialPageRoute(
                      //       builder: (context) =>PanDetails(isworkdetailsCompleted: true, from: "")),
                      // );
                      // if(res == true){
                    ...
                    child: Builder(
                      builder: (BuildContext context) {
                        return Padding(
                          ...
                          child: Image.asset(
                            item,
                            fit: BoxFit.contain, // Adjust fit for better image display
                          ),
                        );
                      },
                    ),
              ...
              SizedBox(
                ...
                child: GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 1,
                    childAspectRatio: screenWidth / (screenHeight * 0.18), // Adjust aspect ratio
                  ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  Text(
                                    result![index].name ?? "", // Replace with dynamic data
                                    style: TextStyle(
                                      color: Color(0xFF000000),
                                      fontWeight: FontWeight.w500,
                              ...
                              InkWell(
                                onTap:(){
                                  if(is_selected){
                                    ...
                                    SelectLoanType(result![index].id);
                                  }
                                },
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                        child:
                                        Text(
                                          (loan_id == result![index].id) ? formatLoanStatus(loan_status) : "Apply",
                                          style: TextStyle(
                          ...
                          onPressed: () {
                            ...
                            setState(() {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>MySignup()), // Replace with your next screen
                              );
                            });
                          },
                          child: const Text(
